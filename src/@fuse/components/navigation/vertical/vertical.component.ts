    ...
    implements OnChanges, OnInit, AfterViewInit, OnDestroy
{
    ...
    ngOnInit(): void {
        ...
        if (roleEncryption != null) {
            this.roleId = this.encrypt.decryptData(roleEncryption).toString();
            // console.log(this.roleId);
            //console.log(this.navigation);
            //console.log(this._fuseNavigationService.getNavigation('Doctor'), ' Navigation ');
            /* if (role_id == 1) {
                this.hideClass = 'hideDoctor';
            } else if (role_id == 2) {
                this.hideAdmin = true;
