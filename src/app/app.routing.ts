...
export const appRoutes: Route[] = [
    ...
    //     // },
    //     children: [
    //         { path: 'doctor-dashboard', loadChildren: () => import('app/modules/admin/example/example.module').then(m => m.ExampleModule) },
    //         { path: 'admin-dashboard', loadChildren: () => import('app/modules/admin/example/example.module').then(m => m.ExampleModule) },
    //     ]
    // },
    {
        path: 'admin',
    ...
    //     },
    //     children: [
    //         { path: '', loadChildren: () => import('app/modules/doctor/doctor.module').then(m => m.DoctorModule) },
    //     ]
    // },
